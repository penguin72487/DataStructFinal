...
int main() {
    ...
    for(int i=0;i<10;i++){// small K
        cout<<k_Heap[i].get_Date() << " " <<k_Heap[i].get_close() <<endl;
    }
        cout << endl<< "3:" <<endl;
    ...
    cout<<"max_return: "<<max_return<<" on "<<k_Heap[max_index].get_Date() <<endl;
    cout<<"min_return: "<<min_return<<" on "<<k_Heap[min_index].get_Date() <<endl;
    cout << endl<< "6:" <<endl;
    //6
    ...
    cout<<"max_return: "<<max_return2<<" on "<<k_Heap[max_index2].get_Date() <<endl;
    cout<<"min_return: "<<min_return2<<" on "<<k_Heap[min_index2].get_Date() <<endl;
    // cout << endl<< "7:" <<endl;
